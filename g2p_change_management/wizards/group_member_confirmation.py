...
class GroupMemberConfirmationWizard(models.TransientModel):
        ...
        if self.env.context.get('active_id'):
            ...
            if change_request and change_request.draft_record_id and change_request.draft_record_id.is_group:
                ...
                res.update({
                    ...
                    'confirmation_message': self._get_confirmation_message(action_type, member_info.get('count', 0)),
                })
    ...
    def _get_confirmation_message(self, action_type, member_count):
        ...
        return f"This action will update the status of {member_count} draft individual member(s) to '{target_state}'.\n\nDo you want to proceed?"
    ...
    def action_confirm(self):
        ...
        if self.member_count == 0:
            raise UserError("No draft members found to update.")
        ...
        if action_method:
            ...
            raise UserError(f"Action method 'action_{self.action_type}' not found.")
