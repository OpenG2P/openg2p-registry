...
class TestSecurity(TransactionCase):
    ...
    def test_security_groups(self):
        ...
        change_approver_group = self.env.ref(
            "g2p_change_management.group_change_approver", raise_if_not_found=False
        )
        change_admin_group = self.env.ref(
            "g2p_change_management.group_change_admin", raise_if_not_found=False
        )
    ...
    def test_menu_access(self):
        ...
        change_management_menu = self.env.ref(
            "g2p_change_management.menu_change_management_root", raise_if_not_found=False
        )
        if change_management_menu:
            self.assertTrue(change_management_menu.name)

        change_requests_menu = self.env.ref(
            "g2p_change_management.menu_change_request", raise_if_not_found=False
        )
    ...
    def test_action_access(self):
        ...
        change_request_action = self.env.ref(
