...
class TestPerformance(TransactionCase):
    ...
    def test_change_request_search_performance(self):
        ...
        def search_operations():
            ...
            # Search by requester
            results['requester'] = self.env['change.request'].search([('requester_id', '=', self.env.user.id)])
    ...
    def test_partner_computed_fields_performance(self):
        ...
        # Log performance metrics
        self.env['change.request.performance.monitor'].log_performance(
            'partner_computed_fields_computation',
            execution_time,
            result,
            memory_usage,
            'compute'
    ...
    def test_database_query_performance(self):
        ...
        def complex_queries():
            ...
            results['grouped'] = self.env['change.request'].search([
                ('state', '=', 'draft')
            ]).read(['type', 'state'])
